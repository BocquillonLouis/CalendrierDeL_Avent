            ...
            <div class="row my-auto text-center" id="part1">
                <div class="col-md-12">
                    ...
                    ?>
                        ...
                        <br /><img src="../img/8.png"><br /><br />
                        <a href="9.php" class="btn btn-primary trouve">Énigme suivante</a>
                    <?php } else { ?>
                        <p class="lead">Essaie de chercher changer une propriété CSS dans le code.</p>
                        <a hidden class="btn btn-primary" href="8.php?masqueTrouve=true">Bravo, tu as trouvé !</a>
                    <?php } ?>
